...
Hooks.once('ready', () => {
  ...
  game.settings.register(MOD_CONFIG.MODULE_NAME, MOD_CONFIG.OPTION_INCLUDE_GM_ONLY, {
    name: "Include GM-only content",
    hint: "When unchecked, then only documents and sections visible to players will be exported (based on document ownership and SECRET blocks in HTML fields)",
    scope: "world",
    type: Boolean,
    default: true,
    config: true,
